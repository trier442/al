...
const required={
  ...
  '2027-suteuk-eonmae-l05':['서술어 자릿수는 문장에 겉으로 나타난 성분의 수가 아니라','생략된 성분도 문맥에서 필수적으로 복원'],
...
const forbidden={
  '2027-suteuk-eonmae-c01':['문항은 기본형이나 원자료를 먼저 확인','자의성의 예외'],
  '2027-suteuk-eonmae-l03':['더 나누었을 때 뜻이 사라지는 지점을 찾고','형태소의 예외'],
  '2027-suteuk-eonmae-l10':['조사는 형태보다 기능을 기준으로 판정한다','담화의 예외'],
...
async function get(url){
  const res=await fetch(url,{headers:{'user-agent':'modukorean-eonmae-deploy-verifier/1.0','cache-control':'no-cache','pragma':'no-cache'}});
