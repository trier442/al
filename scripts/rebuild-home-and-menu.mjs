...
<section class="hero"><h1>고1 공통국어2 검수 완료 자료</h1><p>출판사별로 전면 검수·교정이 끝난 공통국어2 자료를 통합 목차에서 바로 확인할 수 있습니다.</p></section>
...
<div class="note"><strong>공개 기준</strong> · 검수 완료된 공통국어2 자료만 연결합니다. 개별 작품과 단원은 각 출판사 통합 목차에서 확인할 수 있습니다.</div></main><!-- /wp:html -->`;
const common2Hub=await upsertPage("common-korean-2-reviewed","고1 공통국어2 검수 완료 자료",common2Content,"검수 완료된 공통국어2 자료를 출판사별 통합 목차로 연결합니다.");
...
<section class="hero"><h1>2027 수능특강 검수 완료 자료</h1><p>현재 모두의 국어에서 전면 검수한 2027 수능특강 영역을 연결합니다.</p></section>
<div class="grid"><a class="card" href="${P.lit.link}"><strong>2027 수능특강 문학</strong><span>검수 완료 작품 전체 목차 · 상세 해설 · 변형문제 →</span></a><a class="card" href="${P.hwajak.link}"><strong>2027 수능특강 화법과 작문</strong><span>검수 완료 화법·작문 자료 · 상세 해설 · 변형문제 →</span></a></div></main><!-- /wp:html -->`;
const suteukHub=await upsertPage("2027-suteuk-reviewed","2027 수능특강 검수 완료 자료",suteukContent,"검수 완료된 2027 수능특강 문학과 화법·작문 자료를 연결합니다.");

const cat27=await wp("/wp/v2/categories/27");
const litCount=Number(cat27.count||0);

const home=`<!-- wp:html --><main class="modu-home"><style>
.modu-home{max-width:1140px;margin:0 auto;padding:20px 22px 72px;font-family:system-ui,-apple-system,"Noto Sans KR",sans-serif;color:#17222d}.modu-home *{box-sizing:border-box}.hero{padding:50px 30px;border-radius:22px;background:linear-gradient(135deg,#eef7ff,#fbfdff);border:1px solid #d7e6f0;text-align:center}.hero b{display:inline-block;padding:7px 12px;border-radius:999px;background:#174f78;color:#fff;font-size:13px}.hero h1{margin:16px 0 10px;color:#123e5d;font-size:38px}.hero p{max-width:760px;margin:auto;color:#566a79;font-size:18px;line-height:1.75}.section{margin-top:42px}.section h2{margin:0 0 8px;color:#183f5b;font-size:27px}.section>p{margin:0 0 19px;color:#64727d}.grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:15px}.pubgrid{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:12px}.card{display:block;padding:22px;border:1px solid #d3dfe7;border-radius:14px;background:#fff;text-decoration:none;color:inherit!important;box-shadow:0 3px 12px rgba(30,60,85,.04)}.card:hover{border-color:#6e9fbe;transform:translateY(-2px)}.card strong{display:block;color:#173e59;font-size:19px;line-height:1.45}.card span{display:block;margin-top:8px;color:#657783;line-height:1.6}.big strong{font-size:24px}.badge{display:inline-block!important;width:auto!important;margin:0 0 9px!important;padding:5px 8px;border-radius:999px;background:#eef6fa;color:#276789!important;font-size:12px;font-weight:800}.tools{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:11px}.tool{padding:15px;text-align:center;border-radius:11px;background:#f6f8f9;text-decoration:none;color:#2b4252!important;font-weight:800}.notice{margin-top:38px;padding:18px 20px;background:#fff6e7;border-left:5px solid #df8b27;border-radius:0 12px 12px 0;line-height:1.75}@media(max-width:760px){.hero h1{font-size:29px}.grid,.tools{grid-template-columns:1fr}.hero{padding:38px 20px}}</style>
<section class="hero"><b>모두의 국어 · 검수 완료 자료 중심</b><h1>완성된 자료는 바로 찾을 수 있게 연결합니다</h1><p>공통국어2와 2027 수능특강 문학처럼 전면 검수가 끝난 자료는 메인과 상단 메뉴에서 바로 접근할 수 있도록 정리했습니다.</p></section>
<section id="common2" class="section"><h2>고1 · 공통국어2</h2><p>출판사별 검수 완료 통합 목차입니다.</p><div class="pubgrid">${publishers.map(([name,p])=>`<a class="card" href="${p.link}"><strong>${esc(name)}</strong><span>공통국어2 통합 목차 →</span></a>`).join("")}</div><p style="margin-top:16px"><a href="${common2Hub.link}" style="font-weight:800;color:#17608e">공통국어2 전체 연결 페이지 →</a></p></section>
<section id="suteuk2027" class="section"><h2>고3 / N수 · 2027 수능특강</h2><p>검수 완료된 핵심 영역을 바로 확인하세요.</p><div class="grid"><a class="card big" href="${P.lit.link}"><span class="badge">검수 완료</span><strong>2027 수능특강 문학</strong><span>현재 문학 카테고리 ${litCount}개 공개 자료 · 전체 목차 · 상세 해설 · 변형문제 →</span></a><a class="card big" href="${P.hwajak.link}"><span class="badge">순차 검수·공개 중</span><strong>2027 수능특강 화법과 작문</strong><span>전면 재검수한 화법·작문 자료를 통합 목차에서 확인 →</span></a></div><p style="margin-top:16px"><a href="${suteukHub.link}" style="font-weight:800;color:#17608e">2027 수능특강 검수 완료 자료 전체 보기 →</a></p></section>
...
<div class="notice"><strong>정리 원칙</strong> · 검수가 끝난 자료는 숨기지 않고 메인과 메뉴에 연결합니다. 검수 전·중복·이전 버전 자료는 대표 연결에서 제외하고, 검수 완료본을 기준으로 노출합니다.</div>
</main><!-- /wp:html -->`;
const homeUpdated=await wp("/wp/v2/pages/9",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({content:home,excerpt:"검수 완료된 공통국어2와 2027 수능특강 문학·화법과 작문 자료를 바로 찾을 수 있는 모두의 국어 메인페이지입니다.",status:"publish"})});

// Create or reset clean primary menu
let menus=await wp("/wp/v2/menus?search="+encodeURIComponent("모두의 국어 검수 완료 주메뉴")+"&per_page=20");
let menu=Array.isArray(menus)&&menus.find(x=>x.slug==="modu-reviewed-main");
if(!menu) menu=await wp("/wp/v2/menus",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:"모두의 국어 검수 완료 주메뉴",slug:"modu-reviewed-main"})});
